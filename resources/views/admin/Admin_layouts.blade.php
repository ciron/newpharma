...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>Pharmacy</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{ route('admin.brand') }}" class="sl-menu-link  @yield('brand')">
            <div class="sl-menu-item">
              <i class="menu-item-icon icon fa fa-tree tx-22"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('admin.addproduct') }}" class="nav-link @yield('addproduct')">Add Medicine</a></li>
   ...
   @yield('admin_content')
    ...
    <script src="{{ asset('backend') }}/lib/datatable.js"></script>
    ...
    <script src="{{ asset('backend') }}/lib/summernote/texteditor.js"></script>
